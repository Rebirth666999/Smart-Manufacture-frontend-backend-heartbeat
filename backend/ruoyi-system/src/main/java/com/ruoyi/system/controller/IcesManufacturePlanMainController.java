...
public class IcesManufacturePlanMainController extends BaseController {
    ...
    public TableDataInfo<IcesManufacturePlanMainVo> reviewList(IcesManufacturePlanMainBo bo, PageQuery pageQuery) {
        return iIcesManufacturePlanMainService.queryReviewList(bo, pageQuery);
    }
    ...
    @RepeatSubmit()
    @PostMapping()
    public R<IcesManufacturePlanMainVo> add(@Validated(AddGroup.class) @RequestBody IcesManufacturePlanMainBo bo) {
        return R.ok(iIcesManufacturePlanMainService.insertByBo(bo));
    }
